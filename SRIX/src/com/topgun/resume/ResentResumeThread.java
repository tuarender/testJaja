...
public class ResentResumeThread extends Thread
{
	private Track track=null;
	
	public ResentResumeThread(Track track)
	{
		this.track=track;
		...
		if(track.getSent()!=1)
		{
			...
			if(buffer!=null)
			{
				...
				try
				{
					...
					mailMgr.setRecepient(track.getEmpOther());
					//mailMgr.setRecepient("anuwat@topgunthailand.com,anuwat.palasak@gmail.com");
					mailMgr.setSubject(subject);	
					String rejectInformation="idEmp:"+track.getIdEmp()+"#idPosition:"+track.getIdPosition()+"#idJsk:"+track.getIdJsk()+"#idResume:"+track.getIdResume()+"#emailRecipient:"+track.getEmpOther()+"#emailSender:"+jsk.getUsername();
