...
<script>
	$(document).ready(function()
	{
		...
		{
			window.location.href = '/SRIX?view=targetJob&idResume=<c:out value="${resume.idResume}"/>&sequence=1';
		});
	});
</script>
<br>
...
<div class="row" align="center">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<input type="button"  class="btn btn-lg btn-success" id="buttonNext" value="<fmt:message key="GLOBAL_NEXT"/>" onClick="ga('send', 'event', { eventCategory:'Engage-JobMatch', eventAction: 'ClickOn', eventLabel: 'ถัดไป'});">
	</div>
</div>
<br>
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<fmt:message key='MESSAGE_JOBMATCH_1'>
...
<div class="row" >
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<fmt:message key='MESSAGE_JOBMATCH_2'/>
	</div>
